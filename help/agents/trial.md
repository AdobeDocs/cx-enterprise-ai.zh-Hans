---
title: Adobe Experience Platform代理试用版
description: 了解Adobe Experience Platform Agent的免费试用版。
...
# Adobe Experience Platform代理试用版

>[!AVAILABILITY]
>
>某些符合条件的Experience Cloud客户在承诺许可之前，可以访问Adobe Experience Platform代理试用版，以在其自己的环境中体验代理的价值。

以下视频旨在支持您了解Adobe Experience Platform Agents试用版。
...
一旦您消耗了10,000个人工智能积分或许可额外人工智能积分的初始一次性权益，试用即结束。 虽然您不会立即失去访问权限或收取使用过量的费用，但这些权益的延长由Adobe自行决定。 一旦试用完成，您必须立即许可额外的AI积分，才能继续使用Experience Platform代理而不会出现中断。 请联系您的Adobe客户团队，以获取有关如何许可其他AI积分的指导。

## 访问和开始使用由Agent Orchestrator提供支持的AI助手
...
>[!TIP]
>
>获取帮助 — 请向[aep-agents-trial-support@adobe.com](mailto:aep-agents-trial-support@adobe.com)发送请求。
...
Adobe Experience Platform代理试用版允许符合条件的客户使用某些代理，无需额外付费，最多可使用10,000个AI信用额度。 目标是在客户做出商业决策之前，提供从这些代理获得体验价值的低摩擦、低风险途径。
...
符合条件的客户在试用中最多可获得10,000个AI积分，这些积分在代理执行任务时消耗。 请注意，这些AI积分仅存在于试用体验期间，如果您在使用全部10,000个AI积分之前许可额外的AI积分，则不会延期。 有关AI信用消耗的详细信息，请阅读[代理作业和AI信用消耗指南](https://experienceleague.adobe.com/zh-hans/docs/core-services/interface/features/ai-credit-consumption)。

### 这要价钱吗？

该试用版无需额外购买。 不会自动转换为付费产品/服务。 如果您决定在试用期之后继续使用代理，您的Adobe客户团队将与您一起过渡到付费服务。
...
请阅读以下指南，以了解有关Agent Orchestrator和AI Assistant的更多信息：
