...
![Agent Orchestrator的营销架构。](./assets/agent-orchestrator/agentic-architecture.png)
...
Adobe Experience Platform代理是专门构建的人工智能代理分组，它们擅长跨客户体验域提供常见作业。 以下是CX Enterprise应用程序中当前可用的Adobe Experience Platform Agent列表：
...
| [Data Insights Agent](https://experienceleague.adobe.com/zh-hans/docs/analytics-platform/using/cja-overview/cja-b2c-overview/data-analysis-ai) | Data Insights Agent可从Customer Journey Analytics中的AI助手访问，是一个创新型人工智能会话代理，可快速高效地回答有关您数据的问题。 它使用来自数据视图的组件和您的实际数据在 Analysis Workspace 中构建相关的可视化图表。 | Customer Journey Analytics |
...
| [Journey Agent](./ajo-agent.md) | Journey Agent允许Adobe Journey Optimizer用户使用自然语言通过四种功能创建、分析和优化历程：[历程创建](./ajo-agent.md#journey-create)、[渠道内容创建](./ajo-agent.md#channel-content-create)、[历程分析](./ajo-agent.md#journey-analyze)和[历程模拟](./ajo-agent.md#journey-simulate)。 有关详细信息，请参阅[Journey Agent指南](./ajo-agent.md)。 | Adobe Journey Optimizer |
...
有关CX Enterprise应用程序中代理可用性的详细信息，请查看CX Enterprise中的[代理AI文档](../overview/agentic-ai.md)。
