...
description: 了解Analytics管理员如何在升级期间使用Adobe同事数据验证技能比较Adobe Analytics和Customer Journey Analytics数据。
hide: true
...
Adobe Co-worker包括验证技能，允许您在从Adobe Analytics升级到Customer Journey Analytics时验证数据。 数据验证在单个会话中完成。
